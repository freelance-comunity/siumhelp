@extends('backLayout.app') @section('title') Añadir variables a Banco @stop @section('content')

<h1>Añadir variables a Banco: <b>{{$bank->name}}</b></h1>
<hr/> {!! Form::open(['url' => 'admin/variable', 'class' => 'form-horizontal']) !!}
